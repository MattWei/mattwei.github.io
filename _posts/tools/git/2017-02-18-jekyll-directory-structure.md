...
category: 工具
---
[源](https://jekyllrb.com/docs/structure/)

Jekyll 可编译使用Markdown, Textile, HTML写的文本
...
对于使用gem-base的theme, jekyll new 之后只会生成一部分目录,可使用bundle show theme_name来查找theme的其他文件
